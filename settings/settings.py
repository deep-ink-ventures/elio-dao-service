...
# soroban
CORE_CONTRACT_ADDRESS = os.environ.get("CORE_CONTRACT_ADDRESS")
VOTES_CONTRACT_ADDRESS = os.environ.get("VOTES_CONTRACT_ADDRESS")
ASSETS_WASM_HASH = os.environ.get("ASSETS_WASM_HASH")
MULTICLIQUE_WASM_HASH = os.environ.get("MULTICLIQUE_WASM_HASH")
POLICY_WASM_HASH = os.environ.get("POLICY_WASM_HASH")
...
SIGNATURE_VALIDITY_PERIOD = int(os.environ.get("SIGNATURE_VALIDITY_PERIOD", 60 * 60 * 24 * 3))  # seconds
